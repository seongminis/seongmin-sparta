...
for music in musics:
    ...
    trash = rank.select_one('span.rank')
    # print(rank.text.strip(trash.text).strip())
    # print(rank.text.strip().strip('하강'))
    # print(rank.text[0] + rank.text[1].strip())
    # print(title.text.strip())
    # print(artist.text)
    # print(title.text.strip(), artist.text)
    # 정답 아래
    # print(rank.text[0] + rank.text[1].strip(), title.text.strip(), artist.text)
    print(rank.text.strip(trash.text).strip(), title.text.strip(), artist.text)
